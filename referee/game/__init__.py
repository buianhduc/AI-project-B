...
@dataclass
class GameEndBothPlayers:
    player_1: Player
    player_2: Player
    result: PlayerColor | None
...
async def gameBothPlayers(
    ...
    yield GameEndBothPlayers(players[PlayerColor.RED], players[PlayerColor.BLUE], winner_color)
